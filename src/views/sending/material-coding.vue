<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <div class="flex-row-space-between">
        <div>
          ...
          <div class="filter-item">
            <span>等级:</span>
            <el-select v-model="searchParam.grade" size="mini" clearable style="width: 100px">
              <el-option
    ...
    >
      ...
      <el-table-column label="物料编号" width="120px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.name }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="英文简称" align="center" width="80px">
        <template slot-scope="{row}">
          <span>{{ row.name }}</span>
        </template>
      </el-table-column>

      <el-table-column label="产品描述" align="center" width="200px">
        <template slot-scope="{row}">
          <span>{{ row.name }}</span>
        </template>
      </el-table-column>

      <el-table-column label="产品说明" align="center" width="200px">
        <template slot-scope="{row}">
          <span>{{ row.name }}</span>
        </template>
      </el-table-column>
