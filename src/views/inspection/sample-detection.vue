  ...
  <div class="app-container">
    <div class="filter-container">
      <div>
        ...
        <div class="filter-item">
          <span>结果录入:</span>
          <el-select v-model="searchParam.guige" size="mini" clearable style="width: 100px">
            <el-option v-for="item in guigeOptions" :key="item" :label="item" :value="item" />
          </el-select>
        </div>
    ...
    <div class="tab-container">
      <el-tabs style="margin-top:5px;" type="border-card">
        <el-tab-pane label="我的任务">
          <span slot="label">
            我的任务<span class="myTask-num">16</span>
          ...
          <div class="app-my-task-container">
            <el-row>
              <el-col :span="24">
                <div>
                  <el-input placeholder="检验单号" style="width: 100px;" size="mini"/>
                </div>
              </el-col>
            </el-row>
            <el-table
            ...
            >
              ...
              <el-table-column label="检验单号" prop="no" align="center" width="150">
              ...
              <el-table-column label="送检时间" width="150px" align="center">
                <template slot-scope="{row}">
              ...
              <el-table-column label="样品规格" align="center" width="80px">
                <template slot-scope="{row}">
                  <span>{{ row.name }}</span>
                </template>
              </el-table-column>

              <el-table-column label="样品等级" align="center" width="80px">
                <template slot-scope="{row}">
                  <span>{{ row.name }}</span>
                </template>
              </el-table-column>
              ...
              <el-table-column label="检项数" align="center" width="80px">
                <template slot-scope="{row}">
                  <span>{{ row.name }}</span>
                </template>
              </el-table-column>

              <el-table-column label="结果录入" align="center" width="200px">
                <template slot-scope="{row}">
                  <span>{{ row.name }}</span>
                </template>
              </el-table-column>
